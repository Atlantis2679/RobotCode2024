...
public class SwerveContants {
    ...
    public final static double MODULE_BL_ABSOLUTE_ANGLE_OFFSET_DEGREES = 129.1171875;
    public final static double MODULE_FL_ABSOLUTE_ANGLE_OFFSET_DEGREES = -25.89;
    public final static double MODULE_FR_ABSOLUTE_ANGLE_OFFSET_DEGREES = -52.38;
    public final static double MODULE_BR_ABSOLUTE_ANGLE_OFFSET_DEGREES = -9.228;
